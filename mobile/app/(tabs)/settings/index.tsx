...
const websiteUrl = process.env.EXPO_PUBLIC_WEBSITE_BASE || 'https://nanochip.site';
const githubUrl =
  process.env.EXPO_PUBLIC_GITHUB_BASE || 'https://github.com/popcorn-prophets/nanochip';
