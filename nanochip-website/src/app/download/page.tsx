...
async function fetchLatestRelease(): Promise<ReleaseInfo> {
  try {
    const res = await fetch(
      'https://api.github.com/repos/popcorn-prophets/nanochip/releases/latest',
    ...
    return {
      ...
      apkUrl:
        ...
        'https://github.com/popcorn-prophets/nanochip/releases/latest',
      apkSize: null,
    };
  }
}
...
export default async function DownloadPage() {
  ...
  const googlePlayUrl =
    ...
    'https://play.google.com/store/apps/details?id=com.nanochip.app';
